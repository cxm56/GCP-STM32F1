...
void HAL_IRQ_Init(void)
{
    ...
    g_IRQInterface.pf_WWDG_IRQHandler               = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_PVD_IRQHandler                = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TAMPER_IRQHandler             = HAL_IRQ_NullEntry;
    ...
    g_IRQInterface.pf_ADC1_2_IRQHandler             = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_USB_HP_CAN1_TX_IRQHandler     = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_USB_LP_CAN1_RX0_IRQHandler    = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_CAN1_RX1_IRQHandler           = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_CAN1_SCE_IRQHandler           = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM1_BRK_IRQHandler           = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM1_UP_IRQHandler            = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM1_TRG_COM_IRQHandler       = HAL_IRQ_NullEntry;
    ...
    g_IRQInterface.pf_TIM4_IRQHandler               = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_I2C1_EV_IRQHandler            = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_I2C1_ER_IRQHandler            = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_I2C2_EV_IRQHandler            = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_I2C2_ER_IRQHandler            = HAL_IRQ_NullEntry;
    ...
    g_IRQInterface.pf_USART3_IRQHandler             = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_RTCAlarm_IRQHandler           = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_USBWakeUp_IRQHandler          = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM8_BRK_IRQHandler           = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM8_UP_IRQHandler            = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM8_TRG_COM_IRQHandler       = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM8_CC_IRQHandler            = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_ADC3_IRQHandler               = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_FSMC_IRQHandler               = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_SDIO_IRQHandler               = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM5_IRQHandler               = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_SPI3_IRQHandler               = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_UART4_IRQHandler              = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_UART5_IRQHandler              = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM6_IRQHandler               = HAL_IRQ_NullEntry;
    g_IRQInterface.pf_TIM7_IRQHandler               = HAL_IRQ_NullEntry;
    ...
    for (int i = 0; i < STM32_DMA_COUNT; i++)
    {
        ...
        {
            g_IRQInterface.pf_DMA_CH_IRQHandler[i][j] = HAL_IRQ_NullEntry;
        }
    }
...
void HAL_IRQ_ReleaseTrgCallback(uint32_t ulTrgSource)
{
    ...
    case IRQ_TRG_EXTI13: 
    case IRQ_TRG_EXTI14: 
    case IRQ_TRG_EXTI15:                g_IRQInterface.pf_EXTI_IRQHandler[ulTrgSource-IRQ_TRG_EXTI0] = HAL_IRQ_NullEntry; break;
    ...
    case IRQ_TRG_DMA1_Channel5:         
    case IRQ_TRG_DMA1_Channel6:         
    case IRQ_TRG_DMA1_Channel7:         g_IRQInterface.pf_DMA_CH_IRQHandler[0][ulTrgSource-IRQ_TRG_DMA1_Channel1] = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_DMA2_Channel1:         
    case IRQ_TRG_DMA2_Channel2:         
    case IRQ_TRG_DMA2_Channel3:         
    case IRQ_TRG_DMA2_Channel4:         
    case IRQ_TRG_DMA2_Channel5:         g_IRQInterface.pf_DMA_CH_IRQHandler[1][ulTrgSource-IRQ_TRG_DMA2_Channel1] = HAL_IRQ_NullEntry; break;

    case IRQ_TRG_WWDG:                  g_IRQInterface.pf_WWDG_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_PVD:                   g_IRQInterface.pf_PVD_IRQHandler                  = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TAMPER:                g_IRQInterface.pf_TAMPER_IRQHandler               = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_RTC:                   g_IRQInterface.pf_RTC_IRQHandler                  = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_FLASH:                 g_IRQInterface.pf_FLASH_IRQHandler                = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_RCC:                   g_IRQInterface.pf_RCC_IRQHandler                  = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_ADC1_2:                g_IRQInterface.pf_ADC1_2_IRQHandler               = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_USB_HP_CAN1_TX:        g_IRQInterface.pf_USB_HP_CAN1_TX_IRQHandler       = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_USB_LP_CAN1_RX0:       g_IRQInterface.pf_USB_LP_CAN1_RX0_IRQHandler      = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_CAN1_RX1:              g_IRQInterface.pf_CAN1_RX1_IRQHandler             = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_CAN1_SCE:              g_IRQInterface.pf_CAN1_SCE_IRQHandler             = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM1_BRK:              g_IRQInterface.pf_TIM1_BRK_IRQHandler             = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM1_UP:               g_IRQInterface.pf_TIM1_UP_IRQHandler              = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM1_TRG_COM:          g_IRQInterface.pf_TIM1_TRG_COM_IRQHandler         = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM1_CC:               g_IRQInterface.pf_TIM1_CC_IRQHandler              = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM2:                  g_IRQInterface.pf_TIM2_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM3:                  g_IRQInterface.pf_TIM3_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM4:                  g_IRQInterface.pf_TIM4_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_I2C1_EV:               g_IRQInterface.pf_I2C1_EV_IRQHandler              = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_I2C1_ER:               g_IRQInterface.pf_I2C1_ER_IRQHandler              = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_I2C2_EV:               g_IRQInterface.pf_I2C2_EV_IRQHandler              = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_I2C2_ER:               g_IRQInterface.pf_I2C2_ER_IRQHandler              = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_SPI1:                  g_IRQInterface.pf_SPI1_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_SPI2:                  g_IRQInterface.pf_SPI2_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_USART1:                g_IRQInterface.pf_USART1_IRQHandler               = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_USART2:                g_IRQInterface.pf_USART2_IRQHandler               = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_USART3:                g_IRQInterface.pf_USART3_IRQHandler               = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_RTCAlarm:              g_IRQInterface.pf_RTCAlarm_IRQHandler             = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_USBWakeUp:             g_IRQInterface.pf_USBWakeUp_IRQHandler            = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM8_BRK:              g_IRQInterface.pf_TIM8_BRK_IRQHandler             = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM8_UP:               g_IRQInterface.pf_TIM8_UP_IRQHandler              = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM8_TRG_COM:          g_IRQInterface.pf_TIM8_TRG_COM_IRQHandler         = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM8_CC:               g_IRQInterface.pf_TIM8_CC_IRQHandler              = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_ADC3:                  g_IRQInterface.pf_ADC3_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_FSMC:                  g_IRQInterface.pf_FSMC_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_SDIO:                  g_IRQInterface.pf_SDIO_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM5:                  g_IRQInterface.pf_TIM5_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_SPI3:                  g_IRQInterface.pf_SPI3_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_UART4:                 g_IRQInterface.pf_UART4_IRQHandler                = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_UART5:                 g_IRQInterface.pf_UART5_IRQHandler                = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM6:                  g_IRQInterface.pf_TIM6_IRQHandler                 = HAL_IRQ_NullEntry; break;
    case IRQ_TRG_TIM7:                  g_IRQInterface.pf_TIM7_IRQHandler                 = HAL_IRQ_NullEntry; break;
