...
void HAL_TIM_ClockEnable(uint8_t uTimeNode)
{
    ...
    case TIM2_BASE:  RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM2,  ENABLE); break;
    case TIM3_BASE:  RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM3,  ENABLE); break;
    case TIM4_BASE:  RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM4,  ENABLE); break;
    case TIM5_BASE:  RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM5,  ENABLE); break;
    case TIM6_BASE:  RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM6,  ENABLE); break;
    case TIM7_BASE:  RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM7,  ENABLE); break;
    ...
    case TIM12_BASE: RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM12, ENABLE); break;
    case TIM13_BASE: RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM13, ENABLE); break;
    case TIM14_BASE: RCC_APB2PeriphClockCmd(RCC_APB1Periph_TIM14, ENABLE); break;
