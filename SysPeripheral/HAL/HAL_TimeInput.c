...
/**
  ...
  * @retval None
  */
static void HAL_TIM_InputConfig(uint8_t uTimeNode, uint8_t uChannelMask, uint8_t uInputMode)
{
    //开时钟
...
{
    //引脚配置
    HAL_TIM_PortConfig(uTimeNode, uChannelMask, HAL_TIME_PORT_INPUT);

    //模式配置
    HAL_TIM_InputConfig(uTimeNode, uChannelMask, uInputMode);
